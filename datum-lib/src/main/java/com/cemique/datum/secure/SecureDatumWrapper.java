 ...
 */
abstract class SecureDatumWrapper<T> implements SecureDatum<T> {
    ...
    SecureDatumWrapper(Provider.StringSource stringProvider, DeterministicCipher keyCipher, Cipher valueCipher
     ...
     */
    private static class SecureStringDatumWrapper implements AsyncDatum<String> {
